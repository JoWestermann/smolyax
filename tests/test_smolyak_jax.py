...
import setup
import test_smolyak
from jax_smoyak.smolyak import \
    MultivariateSmolyakBarycentricInterpolator as SmolN
from jax_smoyak.smolyak_jax import \
    MultivariateSmolyakBarycentricInterpolator as SmolJ
